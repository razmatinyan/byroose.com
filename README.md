...
The current foundation is a responsive Nuxt landing page converted from the original visual template. It includes a source-owned component system, semantic design tokens, reusable Tailwind class groups, Lucide icons, Lenis smooth scrolling, an SSR-safe GSAP integration, a route-aware home intro with SplitText title motion, a scrubbed hero-to-Studio image transition, a case study section with per-case reveals, image parallax, and a trailing project preview, and focused About, Works, Services, Journey, Courses, Blog, and Contact routes under a shared site layout. A cookie notice in that layout records its consent in a cookie, so the banner stays dismissed across visits. Content systems, case studies, forms, analytics, SEO expansion, and additional motion will be added as the project grows.
